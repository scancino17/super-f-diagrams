...
public class MainController {
    ...
    public void createNewAttribute(double posX, double posY, String name){
        ...
        attribute.setRelations(elementsToRelation);
        attribute.setType(selectType());
    ...
    public int selectType(){
        ...
        System.out.println("1.- Derivado");
        System.out.println("2.- Generico");
        System.out.println("3.- Clave");
        System.out.println("4.- Compuesto");
        System.out.println("5.- Multivaluados");
        return a.nextInt();
    }
    ...
    public void finishEntitySelection(){
        if (elementsToRelation.isEmpty())
            ...
            stateC.setState(State.ATTRIBUTE);
        }
        else
    ...
    public void doClickAction(MouseEvent mouseEvent){
        switch(stateC.getState()){
            ...
            case CHOSING_ENTITY:
                ...
                if(checkColition(mouseEvent.getX(), mouseEvent.getY()) != null){
                    ElementWrapper entity = checkColition(mouseEvent.getX(), mouseEvent.getY());
                    if((entity.getElement() instanceof Entity || entity.getElement().getType() == 4) 
                            && !choosed){
